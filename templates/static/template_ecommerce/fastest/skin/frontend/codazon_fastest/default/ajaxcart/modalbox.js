...
Modalbox.Methods = {
        ...
        this.MBwindow = Builder.node("div", {
            ...
            this.MBframe = Builder.node("div", {
                ...
                this.MBheader = Builder.node("div", {
                    ...
                    this.MBcaption = Builder.node("div", {
                        id: "MB_caption"
                    }),
                ...
                this.MBcontent = Builder.node("div", {
                    id: "MB_content"
                }, [
    ...
    _insertContent: function(content) {
        ...
        if (this.options.height == this._options.height)
            ...
            this.MBcontent.setStyle({
                overflow: 'auto',
                height: Element.getHeight(this.MBwindow) - Element.getHeight(this.MBheader) - 11 + 'px'
            });
            this.MBcontent.show();
            this.focusableElements = this._findFocusableElements();
            this._moveFocus(); // Setting focus on first 'focusable' element in content (input, select, textarea, link or button)
    ...
    activate: function(options) {
        ...
        if (this.options.inactiveFade) new Effect.Appear(this.MBwindow, {
            duration: this.options.slideDownDuration
        });
    },
    ...
    deactivate: function(options) {
        ...
        if (this.options.inactiveFade) new Effect.Fade(this.MBwindow, {
            duration: this.options.slideUpDuration,
            to: .75
        });
    },
    ...
    _deinit: function() {
        ...
        Element.setStyle(this.MBcontent, {
            overflow: '',
            height: ''
        });
    },
    ...
    _setWidth: function() { //Set size
        Element.setStyle(this.MBwindow, {
