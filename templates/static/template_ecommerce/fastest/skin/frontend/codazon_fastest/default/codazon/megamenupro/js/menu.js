            ...
            var megaMenu = {
                ...
                _menuTabs: function() {
                    ...
                    $('.menu-tabs', $(self.element)).each(function() {
                        ...
                        $('> .tab-item', $accordion).each(function(index, element) {
                            var $tabItem = $(this),
                                $tabLink = $('> .cdz-link-wrap > .cdz-tab-link', $tabItem),
                                $tabPane = $('> .cdz-tab-pane', $tabItem);
                ...
                _alignMenuLeft: function(conf) {
                    ...
                    function handlerIn($li) {
                        ...
                        var dWidth = $dropdown.outerWidth(),
                            dOffset = $li.offset().left,
                            cWidth = $menuCont.outerWidth(),
                            cOffset = $menuCont.offset().left,
                ...
                _alignMenuRight: function(conf) {
                    ...
                    function handlerIn($li) {
                        var $dropdown = $li.children('.groupmenu-drop').first();
                        var dWidth = $dropdown.outerWidth(),
                            lOffset = $li.offset().left,
                            lWidth = $li.outerWidth(true),
                            cWidth = $menuCont.width(),
                            cOffset = $menuCont.offset().left,
