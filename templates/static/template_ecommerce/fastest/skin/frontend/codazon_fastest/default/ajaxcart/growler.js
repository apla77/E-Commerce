...
Growler = (function() {
    ...
    return Class.create({
        initialize: function(options) {
            ...
            if (IE == 6) {
                var offset = {
                    w: parseInt(this.growler.style.width) + parseInt(this.growler.style.padding) * 3,
                    h: parseInt(this.growler.style.height) + parseInt(this.growler.style.padding) * 3
                };
                switch (opt.location) {
                    case "br":
